...
class RegistrationTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        performSegue(withIdentifier: "updateRegistration", sender: indexPath)
    }
    @IBSegueAction func goToAddRegistrationUpdate(_ coder: NSCoder, sender: Any?) -> AddRegistrationTableViewController? {
